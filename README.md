    ...
    customFavorites: # Read more in 'Custom Favorites' section below
      ...
      all:
        - title: BBC
          ...
          contentIdRegexp: .*radio-name.* # Optional: Use this regular expression to decide when useTitleAsMediaTitle and useThumbnailAsArtwork should apply, especially when media_content_id changes between plays
